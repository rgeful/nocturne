...
export default function StoryCard(
  { id, title, author, excerpt, tags }:
  { id: string; title: string; author: string; excerpt: string; tags: string[] }
) {
  return (
    <Link href={`/story/${id}`}>
      <article className="bg-zinc-900/60 border border-zinc-800 p-4 rounded-xl hover:border-red-700 transition">
